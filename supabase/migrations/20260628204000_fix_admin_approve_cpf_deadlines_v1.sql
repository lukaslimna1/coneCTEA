-- =========================================================================
-- ConeCTEA — Correção na RPC de Aprovação de CPF para Limpar Deadlines Admin
-- 
-- MIGRATION: 20260628204000_fix_admin_approve_cpf_deadlines_v1.sql
-- OBJETIVO: Corrigir a RPC de aprovação para, além das regras anteriores, 
--           definir admin_deadline_started_at = NULL e 
--           admin_deadline_exclusive_at = NULL, satisfazendo a constraint
--           chk_conectea_change_deadlines.
-- =========================================================================
...
COMMENT ON FUNCTION public.conectea_admin_approve_cpf_change_request_v1(uuid)
  IS 'RPC segura para administradores (master/dev) aprovarem a troca de CPF, enviando-a para a etapa de confirmação do titular com prazo, enfileirando o descarte do documento no Drive, expurgando imediatamente a referência dele, e limpando admin deadlines.';
