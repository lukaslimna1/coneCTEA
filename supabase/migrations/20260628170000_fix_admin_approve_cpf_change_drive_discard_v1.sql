-- =========================================================================
-- ConeCTEA — RPC Administrativa para Aprovação de CPF (Fix GC Drive)
-- 
-- MIGRATION: 20260628170000_fix_admin_approve_cpf_change_drive_discard_v1.sql
-- OBJETIVO: Corrigir a RPC de aprovação para enfileirar o descarte do documento
--           do Google Drive antes da transição de status e limpeza.
-- =========================================================================
...
BEGIN
  ...
  -- 5. Enfileirar descarte do Drive ANTES da mudança de status (que aciona a limpeza)
...
COMMENT ON FUNCTION public.conectea_admin_approve_cpf_change_request_v1(uuid)
  IS 'RPC segura para administradores (master/dev) aprovarem a troca de CPF, enviando-a para a etapa de confirmação do titular com prazo, e enfileirando o descarte do documento no Drive.';
