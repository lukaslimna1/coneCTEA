...
--
-- MIGRATION: 20260702174000_fix_dependent_cpf_change_rpc_old_cpf_and_diagnostics.sql
-- OBJETIVO:
...
COMMENT ON FUNCTION private.conectea_create_dependent_cpf_change_request_v1(
  ...
  'Função PL/PGSQL privada restrita a service_role para criação transacional de solicitações de alteração de CPF de dependente. Modificada para normalizar old_cpf_clear para NULL se for string vazia ou inválida, e para retornar stacked diagnostics de internal_error.';
