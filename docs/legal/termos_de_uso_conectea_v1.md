...
A utilização do aplicativo deve ocorrer sempre dentro de sua finalidade comunitária, organizacional e informativa, respeitando os limites destes Termos de Uso, da Política de Privacidade e das regras definidas pela Família TEA Bauru para cada funcionalidade, solicitação, programa ou ação comunitária.
...
A Família TEA Bauru poderá apoiar, custear, viabilizar ou organizar comunitariamente a primeira consulta ou encaminhamento inicial em determinados programas, mas isso não transforma a Família

TEA Bauru ou o ConeCTEA em clínica, consultório, plano de saúde, operadora de saúde, serviço médico, serviço odontológico, serviço terapêutico ou prestador direto de atendimento.
...
A exclusão de conta ou remoção de dependente não elimina automaticamente obrigações, registros mínimos ou informações que precisem ser mantidas por segurança, prevenção de uso indevido,

proteção de direitos, auditoria mínima, cumprimento de obrigação aplicável ou controle administrativo essencial.
