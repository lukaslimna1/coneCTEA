# Política de Privacidade do ConeCTEA

**Versão:** 1.0
**Última atualização:** 21/05/2026
**Aplicativo:** ConeCTEA
**Comunidade responsável pela iniciativa:** Família TEA Bauru
**Natureza da comunidade:** rede de apoio comunitária, informal, social e colaborativa
**Cidade de atuação principal:** Bauru/SP
**E-mail principal:** familiateabauru@gmail.com
**WhatsApp oficial:** +55 14 99101-2961 — Renata Ferreguti, representante/presidente da Família TEA Bauru
**Grupo comunitário oficial:** https://chat.whatsapp.com/Hhl4SmcahMZ3DX8GEkpQ6s?mode=ac_t
...
Em alguns casos, o aplicativo poderá tratar dados de crianças, adolescentes, dependentes, documentos, laudos ou informações relacionadas à participação em programas comunitários. Esses dados exigem cuidado especial e devem ser usados apenas para finalidades compatíveis com o funcionamento do ConeCTEA e com as ações da Família TEA Bauru.
...
O aplicativo poderá apoiar programas comunitários, chamamentos, listas de interesse, comunicação de selecionados e, quando aplicável, o primeiro encaminhamento ou agendamento com profissionais e parceiros participantes. Nesses casos, o ConeCTEA atua como ferramenta de organização e comunicação comunitária, não como prestador direto de serviço médico, odontológico, terapêutico ou clínico.
...
Para permitir o funcionamento do aplicativo, o ConeCTEA poderá coletar e tratar diferentes tipos de dados pessoais, conforme a funcionalidade utilizada pelo usuário, o tipo de cadastro realizado, a solicitação enviada, a participação em programas comunitários e as informações necessárias para organização da Família TEA Bauru.
...
Para criação de conta e acesso ao aplicativo, o ConeCTEA poderá coletar dados como nome completo, CPF, telefone, data de nascimento, e-mail, estado, cidade, senha e confirmação de senha.
...
Quando houver mecanismos adicionais de proteção, segurança, controle de acesso ou criptografia aplicáveis ao armazenamento técnico, eles deverão ser utilizados conforme a infraestrutura disponível e a Política de Privacidade vigente.
...
Funcionalidades futuras de código QR, como validação sem conexão com a internet, registro de presença em eventos, confirmação de participação em programas comunitários, consultas, parceiros, descontos ou emblemas de perfil, somente deverão ser consideradas parte desta Política quando forem efetivamente implementadas, disponibilizadas aos usuários e refletidas em atualização específica dos Termos de Uso e da Política de Privacidade.
...
Dados como laudo médico, CID, tipo sanguíneo, documentos com foto, raça/cor quando informado, dados de crianças, adolescentes, dependentes, responsáveis e informações relacionadas à condição da pessoa podem ser considerados sensíveis ou exigir cuidado especial. Por isso, devem ser tratados apenas para finalidades compatíveis com o ConeCTEA, com acesso restrito ao necessário e conforme esta Política de Privacidade.

O ConeCTEA não deve solicitar dados além do necessário para suas finalidades comunitárias, organizacionais, administrativas, informativas, de segurança e de análise das solicitações. Quando determinado dado não for necessário para uma funcionalidade, ele não deverá ser exigido sem justificativa adequada.
...
O ConeCTEA não deve expor dados de crianças, adolescentes, dependentes ou pessoas vinculadas a outros usuários não autorizados. O acesso a essas informações deverá ser limitado ao próprio usuário

responsável pela conta, à equipe autorizada da Família TEA Bauru e, quando necessário, a profissionais, clínicas ou parceiros envolvidos em programas comunitários específicos, sempre dentro da finalidade informada.
...
Dados como tipo sanguíneo, CID, contato de emergência e dados de responsável poderão ser utilizados, quando informados, para identificação complementar, apoio à organização comunitária,

segurança do beneficiário, contato em situações necessárias e melhoria do atendimento comunitário dentro das funcionalidades disponíveis.
...
A Família TEA Bauru poderá suspender, reprovar, renovar, corrigir, atualizar ou invalidar uma carteirinha comunitária quando houver inconsistência, pendência documental, uso indevido, vencimento, solicitação de revisão, necessidade administrativa ou descumprimento das regras aplicáveis.

Quando uma carteirinha for aprovada, os documentos sensíveis utilizados para conferência, como documento com foto e laudo médico, deverão seguir as regras de retenção, descarte e exclusão descritas nesta Política de Privacidade.
...
O usuário reconhece que programas comunitários podem possuir regras próprias, limites de vagas, critérios de participação e condições específicas, que poderão ser comunicadas dentro do aplicativo ou pelos canais oficiais da Família TEA Bauru.
...
O compartilhamento com parceiros não deverá incluir documento com foto, laudo médico, CPF completo, CID, tipo sanguíneo, TEA ID, código QR ou informações sensíveis além do necessário, salvo quando houver finalidade específica, necessidade justificada, autorização adequada, obrigação aplicável ou exigência própria da ação comunitária.

A Família TEA Bauru deverá buscar limitar o compartilhamento ao mínimo necessário para a finalidade correspondente, evitando envio de dados excessivos ou incompatíveis com o programa, ação ou atendimento inicial.

Profissionais, clínicas, consultórios, parceiros ou pessoas autorizadas que receberem dados por meio do ConeCTEA deverão utilizar essas informações apenas para a finalidade vinculada à ação, como contato, confirmação, agendamento, atendimento inicial, organização comunitária ou execução do programa.

O recebimento de dados por parceiro não autoriza uso para publicidade própria, abordagem não relacionada, compartilhamento com terceiros, criação de cadastro externo sem finalidade compatível ou qualquer uso estranho ao programa comunitário que justificou o compartilhamento.

Quando a continuidade de atendimento passar a ocorrer diretamente entre participante, responsável e profissional ou clínica parceira, essa relação poderá ficar fora do ambiente do ConeCTEA, conforme regras próprias do profissional, clínica ou serviço responsável.

A Família TEA Bauru não vende dados pessoais de usuários, beneficiários, dependentes, crianças, adolescentes ou participantes cadastrados.

Dados estatísticos, agregados e generalizados poderão ser compartilhados com parceiros, empresas, apoiadores, projetos ou possíveis financiadores para demonstrar impacto social, alcance comunitário,

quantidade de pessoas atendidas, cidades alcançadas, faixas etárias agrupadas ou indicadores gerais, desde que não permitam identificação individual dos participantes.

O compartilhamento de dados com serviços técnicos necessários ao funcionamento do aplicativo, como banco de dados, autenticação, notificações, armazenamento, infraestrutura ou ferramentas operacionais, será tratado em seção específica desta Política de Privacidade.

Em caso de dúvida sobre compartilhamento de dados, o usuário poderá entrar em contato pelos canais oficiais da Família TEA Bauru indicados nesta Política.
...
As notificações devem evitar exposição de dados sensíveis e, sempre que possível, devem apenas informar que há uma atualização disponível no aplicativo, mantendo detalhes protegidos dentro da área autenticada do ConeCTEA.

O ConeCTEA poderá utilizar Google Apps Script, Google Drive ou ferramentas equivalentes como apoio técnico e operacional para recebimento, organização temporária, análise, tratamento ou descarte de documentos e anexos vinculados a solicitações, conforme os fluxos técnicos existentes e as regras de retenção descritas nesta Política.

Documentos com foto, laudos médicos e anexos sensíveis, quando enviados por meio do ConeCTEA, deverão ser tratados como dados de cuidado especial, com acesso restrito ao necessário, retenção pelo menor tempo possível e descarte conforme os critérios aplicáveis à aprovação, pendência, reprovação, suspensão, revisão ou exclusão de conta.

O uso de serviços técnicos de terceiros poderá envolver o tratamento de dados pessoais por essas plataformas, sempre dentro das finalidades necessárias ao funcionamento do aplicativo, à segurança, à autenticação, ao armazenamento, às notificações, ao suporte ou à execução das funcionalidades disponíveis.

A Família TEA Bauru deverá buscar utilizar esses serviços de forma compatível com a finalidade comunitária do ConeCTEA, evitando coleta excessiva, exposição indevida, compartilhamento desnecessário ou armazenamento superior ao necessário.

O ConeCTEA poderá gerar identificadores técnicos internos, registros de sessão, identificadores de usuário, identificadores de notificação, identificadores de validação, TEA ID, status internos e registros mínimos de funcionamento para permitir segurança, organização, controle de acesso, validação comunitária e suporte técnico.

Esses identificadores técnicos não devem ser utilizados como documento oficial, identificação civil, registro governamental, comprovação médica ou identificação pública fora da finalidade do ConeCTEA.

A Família TEA Bauru não controla integralmente a infraestrutura, disponibilidade, políticas, atualizações, falhas, interrupções ou mudanças realizadas pelos serviços técnicos de terceiros utilizados no funcionamento do aplicativo.

Em caso de falhas, indisponibilidades, instabilidades, interrupções, erros de autenticação, falhas de notificação, dificuldade de acesso ou problemas técnicos relacionados a serviços externos, o ConeCTEA poderá apresentar limitações temporárias de funcionamento.

A utilização de serviços técnicos deverá observar, sempre que possível, medidas de segurança, controle de acesso, minimização de dados, restrição de permissões, proteção de documentos sensíveis e redução de exposição de informações pessoais.

O ConeCTEA não deverá registrar em logs ou relatórios técnicos dados sensíveis desnecessários, como CPF completo, laudo médico, documento com foto, CID, código QR bruto, TEA ID associado a dados excessivos, senhas, credenciais de acesso, URLs completas de documentos, identificadores de arquivos externos ou conteúdo integral de anexos.

Quando registros técnicos forem necessários para suporte, manutenção, segurança ou correção de falhas, eles deverão ser limitados ao mínimo necessário e tratados com cuidado para evitar exposição indevida de dados pessoais ou sensíveis.

O usuário reconhece que o funcionamento do ConeCTEA depende de infraestrutura digital, conexão com a internet, serviços externos e dispositivos compatíveis, podendo haver falhas, atrasos ou indisponibilidades fora do controle direto da Família TEA Bauru.
...
O ConeCTEA poderá utilizar serviços técnicos de notificação, como OneSignal ou tecnologia equivalente, para permitir o envio dessas comunicações ao dispositivo do usuário.

As notificações deverão ser utilizadas de forma compatível com a finalidade comunitária, organizacional, administrativa e informativa do ConeCTEA.

Sempre que possível, notificações deverão evitar exposição de dados pessoais ou sensíveis. Informações como CPF completo, documento com foto, laudo médico, CID, diagnóstico, tipo sanguíneo, código QR, TEA ID associado a dados excessivos, motivo sensível de reprovação, motivo sensível de suspensão ou informações detalhadas de dependentes não devem ser exibidas diretamente em notificações.

Quando uma informação exigir cuidado especial, a notificação poderá apenas avisar que existe uma atualização disponível, orientando o usuário a acessar o ambiente autenticado do aplicativo para consultar os detalhes.

O usuário reconhece que notificações podem aparecer na tela do dispositivo, inclusive em tela bloqueada ou em área visível do sistema operacional, conforme as configurações do aparelho. Por isso, o ConeCTEA deverá buscar limitar o conteúdo sensível exibido diretamente em notificações.

O recebimento de notificações poderá depender de permissão concedida pelo usuário, configurações do dispositivo, conexão com a internet, disponibilidade dos serviços técnicos utilizados, funcionamento do sistema operacional e compatibilidade do aparelho.

O usuário poderá gerenciar permissões de notificação nas configurações do dispositivo ou, quando disponível, nas configurações do próprio aplicativo.

A ausência de recebimento de notificação, por falha técnica, bloqueio de permissão, instabilidade de internet, configuração do aparelho, indisponibilidade do serviço ou qualquer outro motivo, não elimina a responsabilidade do usuário de acompanhar suas solicitações, carteirinha, programas e comunicações dentro do aplicativo ou pelos canais oficiais da Família TEA Bauru.

A Família TEA Bauru também poderá utilizar canais oficiais externos, como e-mail, WhatsApp, grupo comunitário, Instagram ou outros meios informados oficialmente, para comunicações gerais, suporte, orientação comunitária ou avisos relevantes, conforme a natureza da informação.
...
A Família TEA Bauru deverá buscar adotar medidas técnicas e organizacionais compatíveis com a natureza dos dados tratados, especialmente quando envolver CPF, documentos com foto, laudos médicos, CID, raça/cor quando informado, dados de crianças, adolescentes, dependentes, responsáveis, solicitações, motivos administrativos, carteirinha comunitária, código QR e informações relacionadas a programas comunitários.
...
O acesso aos dados deverá ser limitado às pessoas autorizadas, conforme a finalidade da informação e a necessidade de atuação, como equipe responsável pela organização da Família TEA Bauru, administradores autorizados, suporte, responsáveis por análise de solicitações e, quando aplicável, profissionais, clínicas ou parceiros envolvidos em programas comunitários específicos.

Documentos com foto, laudos médicos e anexos sensíveis deverão ser tratados com cuidado especial, acesso restrito ao necessário e retenção limitada ao tempo necessário para análise, conferência, correção de pendências, revisão, segurança, prevenção de uso indevido ou cumprimento de obrigação aplicável.

Para reduzir exposição direta de dados pessoais, documentos enviados poderão receber nomes técnicos internos, como DOC_MBR seguido de sequência hexadecimal para documentos com foto, ou LAUDO_MBR seguido de sequência hexadecimal para laudos médicos, evitando que o nome original do arquivo exponha diretamente nome, CPF, diagnóstico ou outras informações pessoais.

Essa renomeação técnica é uma medida de organização e redução de exposição, mas não altera a natureza sensível dos documentos. Mesmo renomeados, documentos com foto, laudos, CID e dados relacionados à condição da pessoa continuam exigindo cuidado especial.
...
Quando registros técnicos forem necessários para suporte, manutenção, correção de falhas ou segurança, eles deverão ser limitados ao mínimo necessário, preferencialmente com informações genéricas, mascaradas ou técnicas, sem exposição indevida de dados pessoais ou sensíveis.

Nenhum sistema digital é totalmente imune a falhas, indisponibilidades, incidentes, acessos indevidos ou problemas técnicos. A Família TEA Bauru deverá buscar reduzir riscos e atuar com cuidado, mas não pode garantir segurança absoluta em todos os cenários.

Em caso de suspeita de acesso indevido, falha de segurança, uso não autorizado de conta, exposição indevida de dados ou problema relacionado à privacidade, o usuário deverá entrar em contato pelos canais oficiais da Família TEA Bauru para orientação e análise da situação.
...
Caso a solicitação apresente pendências, inconsistências, documento incorreto, laudo incompatível, dados divergentes ou necessidade de correção, a Família TEA Bauru poderá devolver a solicitação ao usuário para ajuste, complementação ou reenvio de informações.

O prazo para correção de pendências poderá ser de 7, 15 ou 30 dias, conforme definido pela equipe responsável e informado ao usuário dentro do aplicativo ou pelos canais oficiais, de acordo com a natureza da pendência, necessidade de análise e organização comunitária.

Enquanto houver pendência ativa dentro do prazo informado, os documentos e informações enviados permanecerão armazenados temporariamente para permitir continuidade da análise, correção dos dados, conferência documental e decisão administrativa sobre a solicitação.

Após a correção da pendência pelo usuário, a solicitação poderá retornar para nova análise da Família TEA Bauru, com prazo estimado adicional de até 5 dias úteis, salvo necessidade de nova conferência, nova pendência, indisponibilidade operacional, falha técnica ou situação excepcional.

Quando a carteirinha digital comunitária for aprovada pela equipe, por meio da ação Aprovar Carteirinha no fluxo administrativo do ConeCTEA, o sistema dispara automaticamente o processo de exclusão dos documentos sensíveis utilizados para conferência, incluindo documento com foto e laudo médico.

No fluxo atual do aplicativo, após a aprovação da carteirinha, esses documentos sensíveis são removidos automaticamente do armazenamento operacional utilizado pelo ConeCTEA, incluindo o apoio documental em Google Drive, deixando de ficar disponíveis para acesso pela equipe dentro do fluxo do aplicativo.

A finalidade desse descarte automático é reduzir o armazenamento de dados sensíveis, evitar retenção desnecessária de documentos e proteger a privacidade dos usuários, dependentes e beneficiários cadastrados.

Após a aprovação e o descarte dos documentos sensíveis, a Família TEA Bauru deverá manter apenas os dados necessários para funcionamento da carteirinha comunitária, validação interna, histórico mínimo, segurança, organização administrativa e cumprimento das finalidades descritas nesta Política.

Caso o prazo de correção da pendência termine sem que o usuário realize a correção solicitada, a solicitação ou carteirinha poderá entrar automaticamente em suspensão, conforme as regras técnicas e administrativas do ConeCTEA.

A suspensão tem prazo de até 30 dias para que o usuário solicite revisão, apresente esclarecimentos, corrija informações ou regularize a situação, conforme as orientações fornecidas no aplicativo ou pelos canais oficiais.

Durante o prazo de suspensão, os dados e documentos necessários poderão permanecer armazenados temporariamente para permitir reavaliação, continuidade do processo e possível retorno da solicitação ao fluxo de análise.

Caso o usuário solicite revisão dentro do prazo de suspensão, a Família TEA Bauru poderá manter os dados necessários enquanto a revisão estiver em andamento, exclusivamente para reavaliar a situação e decidir sobre liberação, manutenção da suspensão, reprovação ou encerramento do pedido.

Caso o prazo de 30 dias de suspensão termine sem correção, manifestação ou solicitação de revisão válida, o sistema deverá encerrar o fluxo e disparar automaticamente o processo de exclusão dos dados e documentos vinculados àquela solicitação ou carteirinha no banco de dados operacional e no armazenamento utilizado pelo ConeCTEA.

Em caso de reprovação da solicitação, os dados sensíveis e documentos vinculados ao pedido reprovado deverão ser removidos do banco de dados operacional e do armazenamento utilizado pelo ConeCTEA, mantendo-se apenas o registro mínimo necessário do resultado da análise, como o motivo da reprovação, quando aplicável, para orientação do usuário, segurança, controle administrativo e prevenção de uso indevido.

A reprovação de uma solicitação não impede que o usuário realize uma nova solicitação futuramente, desde que informe corretamente os dados necessários, envie documentos adequados e siga as regras vigentes no momento do novo pedido.

O ConeCTEA não deverá manter documento com foto, laudo médico ou anexos sensíveis por prazo superior ao necessário para análise, correção de pendências, revisão de suspensão, segurança, prevenção de uso indevido, cumprimento de obrigação aplicável ou proteção de direitos.

Em caso de falha técnica, indisponibilidade de internet, erro temporário em serviço externo ou interrupção no processamento automático, o ConeCTEA poderá precisar realizar nova tentativa, verificação técnica ou procedimento de correção para concluir a exclusão prevista neste fluxo.

A exclusão de documentos e dados do banco de dados operacional ou do armazenamento utilizado pelo ConeCTEA não desfaz automaticamente comunicações externas já realizadas, mensagens enviadas por e-mail ou WhatsApp, registros mínimos necessários para segurança, informações já encaminhadas a parceiros quando aplicável, ou dados que precisem ser mantidos por obrigação legal, proteção de direitos, auditoria mínima ou prevenção de uso indevido.
...
A exclusão de conta poderá apagar dados cadastrais, dados de perfil, solicitações, carteirinhas comunitárias vinculadas, dependentes associados, registros operacionais vinculados à conta, notificações internas e demais informações mantidas no banco de dados operacional do ConeCTEA.

Após a exclusão, o usuário perderá acesso à carteirinha digital comunitária, histórico de solicitações, programas comunitários, notificações, dados de dependentes, informações de conta e demais funcionalidades vinculadas ao cadastro excluído.

Quando houver dependentes vinculados à conta, a exclusão da conta também poderá remover os dados desses dependentes do banco de dados operacional do ConeCTEA, conforme o vínculo existente e as regras técnicas do aplicativo.

O ConeCTEA também poderá permitir a remoção individual de dependentes vinculados à conta. Ao confirmar a remoção de um dependente, o usuário reconhece que os dados vinculados àquele dependente serão apagados do banco de dados operacional do aplicativo, conforme o fluxo técnico disponível.

A remoção de dependente poderá apagar informações cadastrais, solicitações, carteirinhas comunitárias, documentos pendentes, registros operacionais e demais dados vinculados ao dependente removido.

A exclusão de conta ou remoção de dependente não deve ser realizada caso o usuário tenha dúvidas sobre os efeitos da ação. Antes de confirmar, recomenda-se ler atentamente os avisos exibidos no aplicativo.

A exclusão de conta ou remoção de dependente poderá ser irreversível dentro do aplicativo. Após a confirmação, os dados removidos poderão não ser recuperados.

A exclusão de conta ou remoção de dependente não desfaz automaticamente comunicações já realizadas, mensagens já enviadas por e-mail, WhatsApp ou outros canais externos, registros necessários para segurança, prevenção de fraude, defesa de direitos, auditoria mínima, suporte já prestado ou informações eventualmente encaminhadas a profissionais, clínicas, parceiros ou canais externos antes da exclusão, quando aplicável.

Caso existam documentos, informações ou registros mantidos fora do banco de dados operacional do ConeCTEA, como comunicações por e-mail, WhatsApp, documentos já encaminhados a parceiros,

registros técnicos mínimos ou informações necessárias por obrigação legal, segurança, auditoria ou proteção de direitos, esses itens poderão depender de análise ou procedimento específico.

A exclusão de conta não impede que o usuário crie uma nova conta futuramente, caso deseje voltar a utilizar o ConeCTEA. Nesse caso, poderá ser necessário realizar novo cadastro, aceitar os Termos de Uso e a Política de Privacidade vigentes, preencher novamente as informações necessárias e realizar novas solicitações, sem garantia de recuperação de dados excluídos anteriormente.

Em caso de dúvida sobre exclusão de conta, remoção de dependente ou dados vinculados, o usuário poderá entrar em contato pelos canais oficiais da Família TEA Bauru indicados nesta Política.
...
Dados de dependentes vinculados à conta também poderão ser corrigidos ou atualizados dentro do aplicativo, conforme o fluxo disponível, respeitando o vínculo entre o usuário responsável pela conta e a pessoa vinculada.
...
Essa análise tem a finalidade de proteger a conta, evitar fraude, impedir alteração indevida de dados sensíveis, preservar a integridade das solicitações e garantir que informações vinculadas à carteirinha comunitária sejam alteradas de forma segura.

Quando o usuário identificar erro em dados sensíveis, protegidos ou vinculados à carteirinha comunitária, poderá utilizar o fluxo disponível dentro do próprio aplicativo para solicitar correção, revisão ou atualização.

A Família TEA Bauru poderá solicitar informações complementares, documentos, confirmação de identidade, justificativa ou outros elementos necessários para avaliar a correção solicitada, especialmente quando a alteração envolver dados sensíveis, dependentes, documentos, laudos ou informações vinculadas à carteirinha.
...
Quando a correção envolver dados de dependente, criança, adolescente, familiar ou pessoa vinculada à conta, a Família TEA Bauru poderá exigir cuidado adicional para confirmar vínculo, legitimidade, autorização ou responsabilidade adequada do usuário solicitante.

A alteração de dados em uma conta, dependente ou solicitação poderá impactar solicitações em andamento, carteirinhas comunitárias, status de análise, participação em programas comunitários, notificações, registros administrativos e validações internas.

Quando uma correção alterar informação usada na solicitação da carteirinha comunitária, a solicitação poderá retornar para análise, revisão ou conferência documental, conforme o caso.
...
A Família TEA Bauru poderá corrigir, atualizar, bloquear temporariamente ou solicitar revisão de dados quando identificar inconsistência, duplicidade, erro, divergência documental, suspeita de uso indevido, informação incompleta ou risco à segurança dos participantes.

Correções realizadas no banco de dados operacional do ConeCTEA não alteram automaticamente documentos, mensagens, registros externos, comunicações por WhatsApp, e-mails já enviados, dados já encaminhados a parceiros ou informações mantidas fora do fluxo técnico do aplicativo.

Os canais oficiais da Família TEA Bauru poderão ser utilizados para dúvidas, suporte, orientação ou acompanhamento de situações em que o usuário tenha dificuldade para realizar a correção dentro do aplicativo ou quando a funcionalidade disponível exigir apoio da equipe.

Em caso de dúvida sobre correção ou atualização de dados, o usuário poderá entrar em contato pelos canais oficiais da Família TEA Bauru indicados nesta Política.

## 16. Direitos do usuário sobre seus dados

O usuário poderá solicitar informações, orientações, correções, atualizações, exclusão ou esclarecimentos relacionados aos seus dados pessoais tratados pelo ConeCTEA, conforme as funcionalidades disponíveis no aplicativo, os canais oficiais da Família TEA Bauru e a legislação aplicável.
...
O usuário poderá solicitar esclarecimentos sobre quais dados são tratados pelo ConeCTEA, para quais finalidades são utilizados, quais informações são necessárias para funcionamento do aplicativo e em quais situações poderão ser compartilhadas com parceiros ou serviços técnicos.

O usuário poderá corrigir ou atualizar dados pelo próprio aplicativo, conforme o fluxo disponível, ou buscar apoio pelos canais oficiais da Família TEA Bauru quando tiver dificuldade, dúvida ou quando a correção depender de análise da equipe.

O usuário poderá solicitar a exclusão de sua conta diretamente pelo aplicativo, conforme descrito nesta Política, reconhecendo que essa ação poderá apagar dados vinculados ao banco de dados operacional do ConeCTEA e encerrar o acesso às funcionalidades da conta.

Quando houver dependentes vinculados à conta, o usuário poderá remover dependentes conforme o fluxo disponível no aplicativo, observando os efeitos dessa remoção sobre dados cadastrais, solicitações, carteirinhas comunitárias e registros vinculados.

O usuário poderá solicitar informações sobre compartilhamento de dados com profissionais, clínicas, parceiros ou serviços técnicos, especialmente quando houver participação em programas comunitários, chamamentos, agendamentos iniciais ou ações da Família TEA Bauru.

Quando determinado tratamento de dados depender de consentimento ou autorização específica, o usuário poderá buscar informações sobre esse consentimento, suas finalidades e os efeitos de eventual revogação, quando aplicável.

A revogação de consentimento ou a recusa em fornecer determinados dados poderá limitar ou impedir o uso de funcionalidades que dependam dessas informações, como solicitação de carteirinha comunitária, participação em programas, validação interna, suporte ou comunicação relacionada ao aplicativo.

Alguns dados poderão ser necessários para funcionamento básico do ConeCTEA, segurança da conta, autenticação, prevenção de uso indevido, análise de solicitações, registros mínimos, proteção de direitos, cumprimento de obrigação aplicável ou organização comunitária. Nesses casos, a exclusão, correção ou limitação de uso poderá depender de análise específica.
...
A Família TEA Bauru poderá solicitar informações adicionais para confirmar identidade, vínculo ou legitimidade antes de atender solicitações relacionadas a dados pessoais, especialmente quando envolver dados sensíveis, documentos, laudos, dependentes, crianças, adolescentes, conta, CPF, e-mail, carteirinha comunitária ou programas com parceiros.

As solicitações serão analisadas conforme a natureza do pedido, as funcionalidades disponíveis, a capacidade operacional da Família TEA Bauru, a segurança dos participantes, a proteção de dados pessoais e a legislação aplicável.

Em caso de dúvida sobre seus dados pessoais, o usuário poderá entrar em contato pelos canais oficiais da Família TEA Bauru indicados nesta Política.
...
Também poderá haver atualização desta Política caso sejam implementadas funcionalidades futuras, como validação sem conexão com a internet, registro de presença em eventos, confirmação de participação em programas por código QR, integração com parceiros, uso de descontos, emblemas de perfil ou novas formas de comunicação e organização comunitária.

A versão atualizada da Política de Privacidade poderá ser disponibilizada dentro do aplicativo, em documento oficial, link público, canal digital, site quando disponível ou outro meio adequado definido pela Família TEA Bauru.
...
A data de última atualização e a versão desta Política deverão ser indicadas no início do documento, sempre que possível, para facilitar a transparência, o controle de versões e a consulta pelos usuários.
...
Para fins de atendimento a solicitações relacionadas à LGPD, privacidade e proteção de dados pessoais no contexto do ConeCTEA, Renata Ferreguti, representante/presidente da Família TEA Bauru, atuará como canal direto de comunicação entre o usuário, o aplicativo ConeCTEA e a comunidade Família TEA Bauru, sem prejuízo do uso dos demais canais oficiais indicados nesta Política.

Essa indicação tem finalidade de facilitar o contato, a organização interna e o encaminhamento de solicitações relacionadas a dados pessoais, sem alterar a natureza comunitária da Família TEA Bauru e sem transformar o ConeCTEA em órgão público, empresa, entidade governamental ou estrutura formal equivalente.
...
O grupo comunitário de WhatsApp e o Instagram poderão ser utilizados para comunicação geral, divulgação de ações, avisos comunitários e aproximação com a comunidade, mas podem não ser os canais mais adequados para tratar assuntos sensíveis ou dados pessoais.

A Família TEA Bauru poderá solicitar informações adicionais para confirmar identidade, vínculo, legitimidade ou responsabilidade antes de responder solicitações relacionadas a dados pessoais, especialmente quando envolver conta, CPF, e-mail, documentos, laudos, dependentes, crianças, adolescentes, carteirinha comunitária ou programas com parceiros.

As solicitações serão analisadas conforme a natureza do pedido, as funcionalidades disponíveis no aplicativo, a capacidade operacional da Família TEA Bauru, a segurança dos participantes, a proteção de dados pessoais e a legislação aplicável.

A Família TEA Bauru buscará responder às solicitações de forma clara, cuidadosa e compatível com sua natureza comunitária, preservando a privacidade, a segurança e a proteção dos usuários, beneficiários, dependentes e participantes cadastrados.

Quando a solicitação envolver dados que estejam em serviços técnicos, registros operacionais, documentos já descartados, informações encaminhadas a parceiros, comunicações externas ou registros mínimos necessários, a resposta poderá depender de análise específica e dos limites técnicos, legais e operacionais aplicáveis.
