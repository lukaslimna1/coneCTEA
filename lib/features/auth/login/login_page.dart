    ...
    try {
      ...
      if (response.user != null) {
        try {
          ...
          if (kDebugMode) {
            debugPrint(
              '[Auth] Falha ao persistir a preferência local de manter conectado.',
            );
          }
        }
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            DsCheckbox(
                              ...
                              description:
                                  'Ao desmarcar, você entrará novamente ao abrir o app.',
                              token: DsCores.sucesso,
                              semanticsLabel:
                                  'Manter a conta conectada no dispositivo',
                            ),
                            const SizedBox(height: 24),
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                border: Border.all(
                                  color: DsCores.dependente.border,
                                ),
                              ),
                              child: Row(
                                children: [
                              ...
                              child: Wrap(
                                ...
                                children: [
                                  Icon(
                                    ...
                                    color: DsCores.seguranca.accent.withValues(
                                      alpha: 0.70,
                                    ),
                                    size: 16,
                                  ),
