                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildBlock(
                        ...
                        text: 'O ConeCTEA é um app comunitário criado para apoiar a organização de informações, solicitações, carteirinhas comunitárias, comunicações e ações da Família TEA Bauru.',
                      ),
                      ...
                      _buildBlock(
                        ...
                        text: 'O app ajuda a centralizar recursos importantes para a comunidade, como cadastro, carteirinha comunitária, acompanhamento de solicitações, notificações, suporte, privacidade e informações institucionais.',
                      ),
                      const SizedBox(height: 16),
                      ...
                      _buildBlock(
                        ...
                        text: 'O ConeCTEA não é órgão público, serviço governamental, serviço médico, clínica, ferramenta de diagnóstico ou documento oficial.',
                      ...
                      _buildBlock(
                        ...
                        text: 'A carteirinha comunitária tem uso interno e comunitário. Ela não substitui CIPTEA, RG, CPF, CNH, laudo, diagnóstico, documento civil ou serviço público.',
                      ),
                      const SizedBox(height: 32),
                    ],
                  ),
