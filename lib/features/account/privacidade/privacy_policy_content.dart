...
class PrivacyPolicyContent {
  ...
  static const String documentTitle = 'Política de Privacidade do ConeCTEA';
  static const String version = '1.0';
  static const String lastUpdated = '21/05/2026';
  static const String appName = 'ConeCTEA';
...
Esse dados opcionais poderão ser utilizados para melhor identificação do usuário, respeito ao nome social, organização comunitária, análise interna, melhoria das ações da Família TEA Bauru e compreensão geral do público atendido, sempre dentro da finalidade do ConeCTEA.
...
O documento com foto poderá ser utilizado para conferência administrativa dos dados informados, especialmente para verificar se nome, CPF and demais informações básicas da solicitação correspondem ao documento apresentado.
...
Esta renomeação técnica tem a finalidade de evitar que nomes de arquivos exponham diretamente nome completo, CPF, documento, laudo, diagnóstico ou outras informações pessoais do usuário, beneficiário ou dependente.
...
A participação em programas comunitários poderá depender de disponibilidade de vagas, ordem de inscrição, criteria específicos da ação, capacidade de atendimento dos parceiros, análise da Família TEA Bauru, confirmação de dados e cumprimento das regras de cada programa.
...
Dados estatísticos, agregados e generalizados poderão ser compartilhados com parceiros, empresas, apoiadores, projetos ou possíveis financiadores para demonstrar impacto social, alcance comunitário, quantidade de pessoas atendidas, cidades alcançadas, faixas etárias agrupadas ou indicadores gerais, desde que não permitam identificação individual dos participantes.
...
Esta renomeação técnica é uma medida de organização e redução de exposição, mas não altera a natureza sensível dos documentos. Mesmo renomeados, documentos com foto, laudos, CID e dados relacionados à condição da pessoa continuam exigindo cuidado especial.
...
Instabilidade e pendência ativa dentro do prazo informado farão com que os documentos e informações enviados permaneçam armazenados temporariamente para permitir continuidade da análise, correção dos dados, conferência documental e decisão administrativa sobre a solicitação.
...
Caso existam documentos, informações ou registros mantidos fora do banco de dados operacional do ConeCTEA, como comunicações por e-mail, WhatsApp, documentos já encaminhados a parceiros, registros técnicos mínimos ou informações necessárias por obrigação legal, segurança, auditoria ou proteção de direitos, esses itens poderão depender de análise ou procedimento específico.
