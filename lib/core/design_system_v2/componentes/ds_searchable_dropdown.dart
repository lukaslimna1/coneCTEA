                    ...
                    return Theme(
                      ...
                      child: IgnorePointer(
                        ...
                        child: SearchAnchor(
                          ...
                          viewTrailing: const [],
                          viewOnOpen: () {
                            // Limpa o texto de busca ao abrir para que a
                            // lista sempre exiba todas as opções.  O valor
                            // selecionado é controlado pelo FormField, não
                            // pelo SearchController.
                            ...
                            return InkWell(
                              ...
                              child: InputDecorator(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  errorMaxLines: 3,
                                  filled: true,
                                  fillColor: DsCores.inputBackground,
                                  isDense: false,
                                ...
                                child: Text(
                                  ...
                                  style: (field.value == null || field.value!.isEmpty)
                                      ? DsTipografia.inputHint.copyWith(
                                          color: widget.enabled ? null : DsCores.textMuted,
                                        )
                                      : DsTipografia.inputText.copyWith(
                            ...
                            return filtered.map((item) {
                              ...
                              return MenuItemButton(
                                onPressed: () {
                                  ...
                                  // Fecha a view sem passar o texto do item
                                  // selecionado para o SearchController.
                                  // Isso evita que a busca reabra pré-filtrada.
                                  // O valor selecionado já está salvo no
                                  // FormField via field.didChange(item).
