...
/// Campo de formulário padronizado para Telefone do Contato de Emergência com máscara e validador local.
class CampoTelefoneContatoEmergencia extends StatelessWidget {
  ...
  const CampoTelefoneContatoEmergencia({
    super.key,
  ...
  Widget build(BuildContext context) {
    final String labelTexto = '${label ?? 'Número do Contato de Emergência (Opcional)'}${requiredField ? ' *' : ''}';
