...
/// Campo de formulário padronizado para Nome Social.
class CampoNomeSocial extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final String labelTexto = '${label ?? 'Nome social (opcional)'}${requiredField ? ' *' : ''}';

    return DsInput(
      label: labelTexto,
      controller: controller,
      enabled: enabled,
      hint: hint ?? 'Como prefere ser chamado(a)',
