...
/// Campo de formulário padronizado tipo Dropdown para Raça ou Cor.
class CampoRacaCor extends StatelessWidget {
  final String? value;
  ...
  Widget build(BuildContext context) {
    final String labelTexto = '${label ?? 'Raça / Cor'}${requiredField ? ' *' : ''}';
      ...
      validator: validator ??
          (requiredField
              ? (value) => ValidadoresCadastrais.campoObrigatorio(
                    value,
                    mensagem: 'Raça / Cor é obrigatória',
                  )
              : null),
    );
  }
